    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-cards">
        <div className="card">
          ...
          <button onClick={() => window.location.href = "/mes-rendezvous"}>{t('dashboard_card_rdv_btn')}</button>
        ...
        <div className="card">
          ...
          <button onClick={() => window.location.href = "/profil"}>{t('dashboard_card_profile_btn')}</button>
        ...
        <div className="card">
          ...
          <p>{t('dashboard_card_settings_text')}</p>
           <button onClick={() => window.location.href = "/parametres"}>{t('dashboard_card_settings_btn')}</button>
        </div>
      </div>
    </div>
  );
